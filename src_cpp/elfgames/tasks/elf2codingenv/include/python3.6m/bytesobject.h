...
PyAPI_FUNC(PyObject*) _PyBytes_FormatEx(
    ...
    PyObject* args,
    int use_bytearray);
PyAPI_FUNC(PyObject*) _PyBytes_FromHex(PyObject* string, int use_bytearray);
#endif
PyAPI_FUNC(PyObject*) PyBytes_DecodeEscape(
    const char*,
    Py_ssize_t,
    const char*,
    Py_ssize_t,
...
PyAPI_FUNC(PyObject*) _PyBytes_DecodeEscape(
    const char*,
    Py_ssize_t,
    const char*,
    Py_ssize_t,
...
#define PyBytes_AS_STRING(op) \
  (assert(PyBytes_Check(op)), (((PyBytesObject*)(op))->ob_sval))
...
#ifndef Py_LIMITED_API
PyAPI_FUNC(Py_ssize_t) _PyBytes_InsertThousandsGroupingLocale(
    char* buffer,
    Py_ssize_t n_buffer,
    char* digits,
    Py_ssize_t n_digits,
