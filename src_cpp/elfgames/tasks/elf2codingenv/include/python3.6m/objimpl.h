...
/* This function returns the number of allocated memory blocks, regardless of
 * size */
...
#define _PyGCHead_FINALIZED(g) \
  (((g)->gc.gc_refs & _PyGC_REFS_MASK_FINALIZED) != 0)
#define _PyGCHead_SET_FINALIZED(g, v)                              \
  do {                                                             \
    (g)->gc.gc_refs =                                              \
        ((g)->gc.gc_refs & ~_PyGC_REFS_MASK_FINALIZED) | (v != 0); \
  } while (0)
