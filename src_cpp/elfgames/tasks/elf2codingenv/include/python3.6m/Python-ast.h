...
enum _expr_kind {
  ...
  Num_kind = 17,
  Str_kind = 18,
  FormattedValue_kind = 19,
  JoinedStr_kind = 20,
  Bytes_kind = 21,
  NameConstant_kind = 22,
  Ellipsis_kind = 23,
  Constant_kind = 24,
  Attribute_kind = 25,
  Subscript_kind = 26,
...
#define FunctionDef(a0, a1, a2, a3, a4, a5, a6, a7) \
  _Py_FunctionDef(a0, a1, a2, a3, a4, a5, a6, a7)
stmt_ty _Py_FunctionDef(
    identifier name,
    arguments_ty args,
    asdl_seq* body,
    asdl_seq* decorator_list,
    ...
    int col_offset,
    PyArena* arena);
#define AsyncFunctionDef(a0, a1, a2, a3, a4, a5, a6, a7) \
  _Py_AsyncFunctionDef(a0, a1, a2, a3, a4, a5, a6, a7)
stmt_ty _Py_AsyncFunctionDef(
    identifier name,
    arguments_ty args,
    asdl_seq* body,
    asdl_seq* decorator_list,
    ...
    int col_offset,
    PyArena* arena);
#define ClassDef(a0, a1, a2, a3, a4, a5, a6, a7) \
  _Py_ClassDef(a0, a1, a2, a3, a4, a5, a6, a7)
stmt_ty _Py_ClassDef(
    identifier name,
    asdl_seq* bases,
    asdl_seq* keywords,
    asdl_seq* body,
...
stmt_ty _Py_AugAssign(
    ...
    int col_offset,
    PyArena* arena);
#define AnnAssign(a0, a1, a2, a3, a4, a5, a6) \
  _Py_AnnAssign(a0, a1, a2, a3, a4, a5, a6)
stmt_ty _Py_AnnAssign(
    expr_ty target,
    expr_ty annotation,
    expr_ty value,
    int simple,
...
stmt_ty _Py_For(
    ...
    int col_offset,
    PyArena* arena);
#define AsyncFor(a0, a1, a2, a3, a4, a5, a6) \
  _Py_AsyncFor(a0, a1, a2, a3, a4, a5, a6)
stmt_ty _Py_AsyncFor(
    expr_ty target,
    expr_ty iter,
    asdl_seq* body,
    asdl_seq* orelse,
...
#define ImportFrom(a0, a1, a2, a3, a4, a5) \
  _Py_ImportFrom(a0, a1, a2, a3, a4, a5)
stmt_ty _Py_ImportFrom(
    identifier module,
    asdl_seq* names,
    int level,
    int lineno,
...
stmt_ty
_Py_Nonlocal(asdl_seq* names, int lineno, int col_offset, PyArena* arena);
...
expr_ty
_Py_YieldFrom(expr_ty value, int lineno, int col_offset, PyArena* arena);
...
#define FormattedValue(a0, a1, a2, a3, a4, a5) \
  _Py_FormattedValue(a0, a1, a2, a3, a4, a5)
expr_ty _Py_FormattedValue(
    expr_ty value,
    int conversion,
    expr_ty format_spec,
    int lineno,
...
expr_ty
_Py_JoinedStr(asdl_seq* values, int lineno, int col_offset, PyArena* arena);
...
expr_ty
_Py_NameConstant(singleton value, int lineno, int col_offset, PyArena* arena);
#define Ellipsis(a0, a1, a2) _Py_Ellipsis(a0, a1, a2)
expr_ty _Py_Ellipsis(int lineno, int col_offset, PyArena* arena);
#define Constant(a0, a1, a2, a3) _Py_Constant(a0, a1, a2, a3)
expr_ty
_Py_Constant(constant value, int lineno, int col_offset, PyArena* arena);
#define Attribute(a0, a1, a2, a3, a4, a5) _Py_Attribute(a0, a1, a2, a3, a4, a5)
expr_ty _Py_Attribute(
    expr_ty value,
    identifier attr,
    expr_context_ty ctx,
    int lineno,
...
comprehension_ty _Py_comprehension(
    expr_ty target,
    expr_ty iter,
    asdl_seq* ifs,
    int is_async,
    PyArena* arena);
#define ExceptHandler(a0, a1, a2, a3, a4, a5) \
  _Py_ExceptHandler(a0, a1, a2, a3, a4, a5)
excepthandler_ty _Py_ExceptHandler(
    expr_ty type,
    identifier name,
    asdl_seq* body,
    int lineno,
    int col_offset,
    PyArena* arena);
#define arguments(a0, a1, a2, a3, a4, a5, a6) \
  _Py_arguments(a0, a1, a2, a3, a4, a5, a6)
arguments_ty _Py_arguments(
    asdl_seq* args,
    arg_ty vararg,
    asdl_seq* kwonlyargs,
    asdl_seq* kw_defaults,
...
withitem_ty
_Py_withitem(expr_ty context_expr, expr_ty optional_vars, PyArena* arena);
