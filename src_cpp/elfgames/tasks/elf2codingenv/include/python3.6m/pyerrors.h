...
typedef struct { PyException_HEAD } PyBaseExceptionObject;
...
typedef struct { PyException_HEAD PyObject* code; } PySystemExitObject;
...
typedef struct { PyException_HEAD PyObject* value; } PyStopIterationObject;
...
#if defined(__clang__) || (defined(__GNUC_MAJOR__) && \
                           ((__GNUC_MAJOR__ >= 3) ||  \
...
PyAPI_FUNC(PyObject*)
    PyErr_SetFromErrnoWithUnicodeFilename(PyObject*, const Py_UNICODE*);
#endif /* MS_WINDOWS */
...
PyAPI_FUNC(PyObject*)
    PyErr_SetFromWindowsErrWithUnicodeFilename(int, const Py_UNICODE*);
#endif
...
PyAPI_FUNC(PyObject*) PyErr_ProgramText(
    ...
    int lineno);
#ifndef Py_LIMITED_API
PyAPI_FUNC(PyObject*) PyErr_ProgramTextObject(PyObject* filename, int lineno);
#endif
