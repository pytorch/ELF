...
MODULE_SCOPE TkMenuReferences* TkCreateMenuReferences(
    Tcl_Interp* interp,
    const char* name);
MODULE_SCOPE void TkDestroyMenu(TkMenu* menuPtr);
MODULE_SCOPE void TkEventuallyRecomputeMenu(TkMenu* menuPtr);
MODULE_SCOPE void TkEventuallyRedrawMenu(TkMenu* menuPtr, TkMenuEntry* mePtr);
MODULE_SCOPE TkMenuReferences* TkFindMenuReferences(
    Tcl_Interp* interp,
    const char* name);
MODULE_SCOPE TkMenuReferences* TkFindMenuReferencesObj(
    Tcl_Interp* interp,
    Tcl_Obj* namePtr);
...
MODULE_SCOPE int TkGetMenuIndex(
    Tcl_Interp* interp,
    TkMenu* menuPtr,
    Tcl_Obj* objPtr,
    int lastOK,
...
MODULE_SCOPE int TkInvokeMenu(Tcl_Interp* interp, TkMenu* menuPtr, int index);
MODULE_SCOPE void TkMenuConfigureDrawOptions(TkMenu* menuPtr);
MODULE_SCOPE int TkMenuConfigureEntryDrawOptions(TkMenuEntry* mePtr, int index);
MODULE_SCOPE void TkMenuFreeDrawOptions(TkMenu* menuPtr);
MODULE_SCOPE void TkMenuEntryFreeDrawOptions(TkMenuEntry* mePtr);
MODULE_SCOPE void TkMenuEventProc(ClientData clientData, XEvent* eventPtr);
MODULE_SCOPE void TkMenuImageProc(
...
MODULE_SCOPE void TkMenuSelectImageProc(
    ClientData clientData,
    int x,
    int y,
    int width,
...
TkNewMenuName(Tcl_Interp* interp, Tcl_Obj* parentNamePtr, TkMenu* menuPtr);
MODULE_SCOPE int TkPostCommand(TkMenu* menuPtr);
MODULE_SCOPE int
TkPostSubmenu(Tcl_Interp* interp, TkMenu* menuPtr, TkMenuEntry* mePtr);
MODULE_SCOPE int
TkPostTearoffMenu(Tcl_Interp* interp, TkMenu* menuPtr, int x, int y);
...
MODULE_SCOPE void TkpDrawMenuEntry(
    TkMenuEntry* mePtr,
    Drawable d,
    Tk_Font tkfont,
...
MODULE_SCOPE int TkpPostMenu(Tcl_Interp* interp, TkMenu* menuPtr, int x, int y);
