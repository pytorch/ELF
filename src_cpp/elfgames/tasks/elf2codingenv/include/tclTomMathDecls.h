...
#define Tcl_TomMath_InitStubs(interp, version) \
  (TclTomMathInitializeStubs(                  \
      (interp), (version), TCLTOMMATH_EPOCH, TCLTOMMATH_REVISION))
...
/* 16 */
EXTERN int TclBN_mp_div_2d(const mp_int* a, int b, mp_int* q, mp_int* r);
/* 17 */
...
/* 65 */
EXTERN void TclBNInitBignumFromWideInt(mp_int* bignum, Tcl_WideInt initVal);
/* 66 */
EXTERN void TclBNInitBignumFromWideUInt(mp_int* bignum, Tcl_WideUInt initVal);
...
typedef struct TclTomMathStubs {
  ...
  int (*tclBN_mp_to_unsigned_bin_n)(
      mp_int* a,
      unsigned char* b,
      unsigned long* outlen); /* 45 */
  int (*tclBN_mp_toradix_n)(
      mp_int* a,
      char* str,
      int radix,
      int maxlen); /* 46 */
  ...
  int (
      *tclBN_s_mp_mul_digs)(mp_int* a, mp_int* b, mp_int* c, int digs); /* 58 */
  ...
  void (*tclBNInitBignumFromWideInt)(
      mp_int* bignum,
      Tcl_WideInt initVal); /* 65 */
  void (*tclBNInitBignumFromWideUInt)(
      mp_int* bignum,
      Tcl_WideUInt initVal); /* 66 */
} TclTomMathStubs;
...
#define TclBN_epoch (tclTomMathStubsPtr->tclBN_epoch) /* 0 */
#define TclBN_revision (tclTomMathStubsPtr->tclBN_revision) /* 1 */
#define TclBN_mp_add (tclTomMathStubsPtr->tclBN_mp_add) /* 2 */
#define TclBN_mp_add_d (tclTomMathStubsPtr->tclBN_mp_add_d) /* 3 */
#define TclBN_mp_and (tclTomMathStubsPtr->tclBN_mp_and) /* 4 */
#define TclBN_mp_clamp (tclTomMathStubsPtr->tclBN_mp_clamp) /* 5 */
#define TclBN_mp_clear (tclTomMathStubsPtr->tclBN_mp_clear) /* 6 */
#define TclBN_mp_clear_multi (tclTomMathStubsPtr->tclBN_mp_clear_multi) /* 7 \
                                                                           */
#define TclBN_mp_cmp (tclTomMathStubsPtr->tclBN_mp_cmp) /* 8 */
#define TclBN_mp_cmp_d (tclTomMathStubsPtr->tclBN_mp_cmp_d) /* 9 */
#define TclBN_mp_cmp_mag (tclTomMathStubsPtr->tclBN_mp_cmp_mag) /* 10 */
#define TclBN_mp_copy (tclTomMathStubsPtr->tclBN_mp_copy) /* 11 */
#define TclBN_mp_count_bits (tclTomMathStubsPtr->tclBN_mp_count_bits) /* 12 */
#define TclBN_mp_div (tclTomMathStubsPtr->tclBN_mp_div) /* 13 */
#define TclBN_mp_div_d (tclTomMathStubsPtr->tclBN_mp_div_d) /* 14 */
#define TclBN_mp_div_2 (tclTomMathStubsPtr->tclBN_mp_div_2) /* 15 */
#define TclBN_mp_div_2d (tclTomMathStubsPtr->tclBN_mp_div_2d) /* 16 */
#define TclBN_mp_div_3 (tclTomMathStubsPtr->tclBN_mp_div_3) /* 17 */
#define TclBN_mp_exch (tclTomMathStubsPtr->tclBN_mp_exch) /* 18 */
#define TclBN_mp_expt_d (tclTomMathStubsPtr->tclBN_mp_expt_d) /* 19 */
#define TclBN_mp_grow (tclTomMathStubsPtr->tclBN_mp_grow) /* 20 */
#define TclBN_mp_init (tclTomMathStubsPtr->tclBN_mp_init) /* 21 */
#define TclBN_mp_init_copy (tclTomMathStubsPtr->tclBN_mp_init_copy) /* 22 */
#define TclBN_mp_init_multi (tclTomMathStubsPtr->tclBN_mp_init_multi) /* 23 */
#define TclBN_mp_init_set (tclTomMathStubsPtr->tclBN_mp_init_set) /* 24 */
#define TclBN_mp_init_size (tclTomMathStubsPtr->tclBN_mp_init_size) /* 25 */
#define TclBN_mp_lshd (tclTomMathStubsPtr->tclBN_mp_lshd) /* 26 */
#define TclBN_mp_mod (tclTomMathStubsPtr->tclBN_mp_mod) /* 27 */
#define TclBN_mp_mod_2d (tclTomMathStubsPtr->tclBN_mp_mod_2d) /* 28 */
#define TclBN_mp_mul (tclTomMathStubsPtr->tclBN_mp_mul) /* 29 */
#define TclBN_mp_mul_d (tclTomMathStubsPtr->tclBN_mp_mul_d) /* 30 */
#define TclBN_mp_mul_2 (tclTomMathStubsPtr->tclBN_mp_mul_2) /* 31 */
#define TclBN_mp_mul_2d (tclTomMathStubsPtr->tclBN_mp_mul_2d) /* 32 */
#define TclBN_mp_neg (tclTomMathStubsPtr->tclBN_mp_neg) /* 33 */
#define TclBN_mp_or (tclTomMathStubsPtr->tclBN_mp_or) /* 34 */
#define TclBN_mp_radix_size (tclTomMathStubsPtr->tclBN_mp_radix_size) /* 35 */
#define TclBN_mp_read_radix (tclTomMathStubsPtr->tclBN_mp_read_radix) /* 36 */
#define TclBN_mp_rshd (tclTomMathStubsPtr->tclBN_mp_rshd) /* 37 */
#define TclBN_mp_shrink (tclTomMathStubsPtr->tclBN_mp_shrink) /* 38 */
#define TclBN_mp_set (tclTomMathStubsPtr->tclBN_mp_set) /* 39 */
#define TclBN_mp_sqr (tclTomMathStubsPtr->tclBN_mp_sqr) /* 40 */
#define TclBN_mp_sqrt (tclTomMathStubsPtr->tclBN_mp_sqrt) /* 41 */
#define TclBN_mp_sub (tclTomMathStubsPtr->tclBN_mp_sub) /* 42 */
#define TclBN_mp_sub_d (tclTomMathStubsPtr->tclBN_mp_sub_d) /* 43 */
...
#define TclBN_mp_toradix_n (tclTomMathStubsPtr->tclBN_mp_toradix_n) /* 46 */
#define TclBN_mp_unsigned_bin_size \
  (tclTomMathStubsPtr->tclBN_mp_unsigned_bin_size) /* 47 */
#define TclBN_mp_xor (tclTomMathStubsPtr->tclBN_mp_xor) /* 48 */
#define TclBN_mp_zero (tclTomMathStubsPtr->tclBN_mp_zero) /* 49 */
#define TclBN_reverse (tclTomMathStubsPtr->tclBN_reverse) /* 50 */
#define TclBN_fast_s_mp_mul_digs \
  (tclTomMathStubsPtr->tclBN_fast_s_mp_mul_digs) /* 51 */
#define TclBN_fast_s_mp_sqr (tclTomMathStubsPtr->tclBN_fast_s_mp_sqr) /* 52 */
#define TclBN_mp_karatsuba_mul \
  (tclTomMathStubsPtr->tclBN_mp_karatsuba_mul) /* 53 */
#define TclBN_mp_karatsuba_sqr \
  (tclTomMathStubsPtr->tclBN_mp_karatsuba_sqr) /* 54 */
#define TclBN_mp_toom_mul (tclTomMathStubsPtr->tclBN_mp_toom_mul) /* 55 */
#define TclBN_mp_toom_sqr (tclTomMathStubsPtr->tclBN_mp_toom_sqr) /* 56 */
#define TclBN_s_mp_add (tclTomMathStubsPtr->tclBN_s_mp_add) /* 57 */
#define TclBN_s_mp_mul_digs (tclTomMathStubsPtr->tclBN_s_mp_mul_digs) /* 58 */
#define TclBN_s_mp_sqr (tclTomMathStubsPtr->tclBN_s_mp_sqr) /* 59 */
#define TclBN_s_mp_sub (tclTomMathStubsPtr->tclBN_s_mp_sub) /* 60 */
#define TclBN_mp_init_set_int \
  (tclTomMathStubsPtr->tclBN_mp_init_set_int) /* 61 */
#define TclBN_mp_set_int (tclTomMathStubsPtr->tclBN_mp_set_int) /* 62 */
#define TclBN_mp_cnt_lsb (tclTomMathStubsPtr->tclBN_mp_cnt_lsb) /* 63 */
