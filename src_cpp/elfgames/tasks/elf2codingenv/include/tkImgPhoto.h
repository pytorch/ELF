...
MODULE_SCOPE void TkImgPhotoConfigureInstance(PhotoInstance* instancePtr);
...
MODULE_SCOPE void TkImgDitherInstance(
    PhotoInstance* instancePtr,
    int x,
    int y,
    int width,
    int height);
MODULE_SCOPE void TkImgPhotoDisplay(
    ...
    int drawableX,
    int drawableY);
MODULE_SCOPE void TkImgPhotoFree(ClientData clientData, Display* display);
