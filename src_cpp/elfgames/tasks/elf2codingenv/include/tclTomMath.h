...
MODULE_SCOPE int KARATSUBA_MUL_CUTOFF, KARATSUBA_SQR_CUTOFF, TOOM_MUL_CUTOFF,
    TOOM_SQR_CUTOFF;
#endif
 ...
 * "dat" is a parameter you can
 * have passed to the callback (e.g. a state or something).  This function
 * doesn't use "dat" itself
 * so it can be NULL
 *
...
#define mp_prime_random(a, t, size, bbs, cb, dat) \
  mp_prime_random_ex(                             \
      a, t, ((size)*8) + 1, (bbs == 1) ? LTM_PRIME_BBS : 0, cb, dat)
 ...
 */
/*
int mp_prime_random_ex(mp_int *a, int t, int size, int flags, ltm_prime_callback
cb, void *dat);
*/
