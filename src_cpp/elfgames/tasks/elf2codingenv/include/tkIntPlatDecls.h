...
/* 0 */
EXTERN char* TkAlignImageData(XImage* image, int alignment, int bitOrder);
/* Slot 1 is reserved */
/* 2 */
EXTERN void TkGenerateActivateEvents(TkWindow* winPtr, int active);
/* 3 */
...
/* 13 */
EXTERN LRESULT
TkWinEmbeddedEventProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam);
/* 14 */
EXTERN void
TkWinFillRect(HDC dc, int x, int y, int width, int height, int pixel);
/* 15 */
EXTERN COLORREF
TkWinGetBorderPixels(Tk_Window tkwin, Tk_3DBorder border, int which);
/* 16 */
EXTERN HDC
TkWinGetDrawableDC(Display* display, Drawable d, TkWinDCState* state);
/* 17 */
...
/* 20 */
EXTERN int TkWinHandleMenuEvent(
    HWND* phwnd,
    UINT* pMessage,
    WPARAM* pwParam,
    LPARAM* plParam,
...
/* 22 */
EXTERN void TkWinReleaseDrawableDC(Drawable d, HDC hdc, TkWinDCState* state);
/* 23 */
EXTERN LRESULT TkWinResendEvent(WNDPROC wndproc, HWND hwnd, XEvent* eventPtr);
/* 24 */
EXTERN HPALETTE TkWinSelectPalette(HDC dc, Colormap colormap);
/* 25 */
EXTERN void TkWinSetMenu(Tk_Window tkwin, HMENU hMenu);
/* 26 */
EXTERN void TkWinSetWindowPos(HWND hwnd, HWND siblingHwnd, int pos);
/* 27 */
...
/* 32 */
EXTERN Tcl_Obj* TkWinGetMenuSystemDefault(
    Tk_Window tkwin,
    const char* dbName,
...
/* 36 */
EXTERN LRESULT __stdcall TkWinChildProc(
    HWND hwnd,
    UINT message,
    WPARAM wParam,
    LPARAM lParam);
...
/* 18 */
EXTERN void TkMacOSXHandleMenuSelect(
    short theMenu,
...
/* Slot 20 is reserved */
/* 21 */
EXTERN void TkMacOSXInvalidateWindow(MacDrawable* macWin, int flag);
/* 22 */
EXTERN int TkMacOSXIsCharacterMissing(Tk_Font tkfont, unsigned int searchChar);
/* 23 */
...
/* 26 */
EXTERN void TkMacOSXRegisterOffScreenWindow(Window window, void* portPtr);
/* 27 */
...
/* 37 */
EXTERN void TkMacOSXWindowOffset(void* wRef, int* xOffset, int* yOffset);
/* 38 */
...
/* 41 */
EXTERN int TkMacOSXZoomToplevel(void* whichWindow, short zoomPart);
/* 42 */
EXTERN Tk_Window Tk_TopCoordsToWindow(
    Tk_Window tkwin,
    int rootX,
    int rootY,
    int* newX,
...
/* 50 */
EXTERN int
TkGenerateButtonEvent(int x, int y, Window window, unsigned int state);
/* 51 */
...
typedef struct TkIntPlatStubs {
  ...
  LRESULT (*tkWinEmbeddedEventProc)
  (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam); /* 13 */
  void (*tkWinFillRect)(
      HDC dc,
      int x,
      int y,
      ...
      int height,
      int pixel); /* 14 */
  COLORREF (*tkWinGetBorderPixels)
  (Tk_Window tkwin, Tk_3DBorder border, int which); /* 15 */
  HDC (*tkWinGetDrawableDC)
  (Display* display, Drawable d, TkWinDCState* state); /* 16 */
  int (*tkWinGetModifierState)(void); /* 17 */
  HPALETTE (*tkWinGetSystemPalette)(void); /* 18 */
  HWND (*tkWinGetWrapperWindow)(Tk_Window tkwin); /* 19 */
  int (*tkWinHandleMenuEvent)(
      HWND* phwnd,
      UINT* pMessage,
      WPARAM* pwParam,
      LPARAM* plParam,
  ...
  LRESULT (*tkWinResendEvent)
  (WNDPROC wndproc, HWND hwnd, XEvent* eventPtr); /* 23 */
  ...
  Tcl_Obj* (*tkWinGetMenuSystemDefault)(
      Tk_Window tkwin,
      const char* dbName,
      const char* className); /* 32 */
  int (*tkWinGetPlatformId)(void); /* 33 */
  void (*tkWinSetHINSTANCE)(HINSTANCE hInstance); /* 34 */
  int (*tkWinGetPlatformTheme)(void); /* 35 */
  LRESULT(__stdcall* tkWinChildProc)
  (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam); /* 36 */
  ...
  void (*tkMacOSXHandleMenuSelect)(
      short theMenu,
      unsigned short theItem,
      int optionKeyPressed); /* 18 */
  void (*reserved19)(void);
  void (*reserved20)(void);
  void (*tkMacOSXInvalidateWindow)(MacDrawable* macWin, int flag); /* 21 */
  int (*tkMacOSXIsCharacterMissing)(
      Tk_Font tkfont,
      unsigned int searchChar); /* 22 */
  ...
  void (
      *tkMacOSXRegisterOffScreenWindow)(Window window, void* portPtr); /* 26 */
  ...
  Tk_Window (*tk_TopCoordsToWindow)(
      Tk_Window tkwin,
      int rootX,
      int rootY,
      int* newX,
...
#if defined(_WIN32) || defined(__CYGWIN__) /* WIN */
#define TkAlignImageData (tkIntPlatStubsPtr->tkAlignImageData) /* 0 */
/* Slot 1 is reserved */
#define TkGenerateActivateEvents \
  (tkIntPlatStubsPtr->tkGenerateActivateEvents) /* 2 */
#define TkpGetMS (tkIntPlatStubsPtr->tkpGetMS) /* 3 */
#define TkPointerDeadWindow (tkIntPlatStubsPtr->tkPointerDeadWindow) /* 4 */
#define TkpPrintWindowId (tkIntPlatStubsPtr->tkpPrintWindowId) /* 5 */
#define TkpScanWindowId (tkIntPlatStubsPtr->tkpScanWindowId) /* 6 */
#define TkpSetCapture (tkIntPlatStubsPtr->tkpSetCapture) /* 7 */
#define TkpSetCursor (tkIntPlatStubsPtr->tkpSetCursor) /* 8 */
#define TkpWmSetState (tkIntPlatStubsPtr->tkpWmSetState) /* 9 */
#define TkSetPixmapColormap (tkIntPlatStubsPtr->tkSetPixmapColormap) /* 10 */
#define TkWinCancelMouseTimer \
  (tkIntPlatStubsPtr->tkWinCancelMouseTimer) /* 11 */
#define TkWinClipboardRender (tkIntPlatStubsPtr->tkWinClipboardRender) /* 12 \
                                                                          */
#define TkWinEmbeddedEventProc \
  (tkIntPlatStubsPtr->tkWinEmbeddedEventProc) /* 13 */
#define TkWinFillRect (tkIntPlatStubsPtr->tkWinFillRect) /* 14 */
#define TkWinGetBorderPixels (tkIntPlatStubsPtr->tkWinGetBorderPixels) /* 15 \
                                                                          */
#define TkWinGetDrawableDC (tkIntPlatStubsPtr->tkWinGetDrawableDC) /* 16 */
...
#define TkWinHandleMenuEvent (tkIntPlatStubsPtr->tkWinHandleMenuEvent) /* 20 \
                                                                          */
#define TkWinIndexOfColor (tkIntPlatStubsPtr->tkWinIndexOfColor) /* 21 */
#define TkWinReleaseDrawableDC \
  (tkIntPlatStubsPtr->tkWinReleaseDrawableDC) /* 22 */
#define TkWinResendEvent (tkIntPlatStubsPtr->tkWinResendEvent) /* 23 */
#define TkWinSelectPalette (tkIntPlatStubsPtr->tkWinSelectPalette) /* 24 */
#define TkWinSetMenu (tkIntPlatStubsPtr->tkWinSetMenu) /* 25 */
#define TkWinSetWindowPos (tkIntPlatStubsPtr->tkWinSetWindowPos) /* 26 */
#define TkWinWmCleanup (tkIntPlatStubsPtr->tkWinWmCleanup) /* 27 */
#define TkWinXCleanup (tkIntPlatStubsPtr->tkWinXCleanup) /* 28 */
#define TkWinXInit (tkIntPlatStubsPtr->tkWinXInit) /* 29 */
#define TkWinSetForegroundWindow \
  (tkIntPlatStubsPtr->tkWinSetForegroundWindow) /* 30 */
#define TkWinDialogDebug (tkIntPlatStubsPtr->tkWinDialogDebug) /* 31 */
#define TkWinGetMenuSystemDefault \
  (tkIntPlatStubsPtr->tkWinGetMenuSystemDefault) /* 32 */
#define TkWinGetPlatformId (tkIntPlatStubsPtr->tkWinGetPlatformId) /* 33 */
#define TkWinSetHINSTANCE (tkIntPlatStubsPtr->tkWinSetHINSTANCE) /* 34 */
#define TkWinGetPlatformTheme \
  (tkIntPlatStubsPtr->tkWinGetPlatformTheme) /* 35 */
#define TkWinChildProc (tkIntPlatStubsPtr->tkWinChildProc) /* 36 */
#define TkCreateXEventSource (tkIntPlatStubsPtr->tkCreateXEventSource) /* 37 \
                                                                          */
#define TkpCmapStressed (tkIntPlatStubsPtr->tkpCmapStressed) /* 38 */
#define TkpSync (tkIntPlatStubsPtr->tkpSync) /* 39 */
#define TkUnixContainerId (tkIntPlatStubsPtr->tkUnixContainerId) /* 40 */
#define TkUnixDoOneXEvent (tkIntPlatStubsPtr->tkUnixDoOneXEvent) /* 41 */
#define TkUnixSetMenubar (tkIntPlatStubsPtr->tkUnixSetMenubar) /* 42 */
#define TkWmCleanup (tkIntPlatStubsPtr->tkWmCleanup) /* 43 */
#define TkSendCleanup (tkIntPlatStubsPtr->tkSendCleanup) /* 44 */
#define TkpTestsendCmd (tkIntPlatStubsPtr->tkpTestsendCmd) /* 45 */
#endif /* WIN */
#ifdef MAC_OSX_TK /* AQUA */
#define TkGenerateActivateEvents \
...
/* Slot 1 is reserved */
/* Slot 2 is reserved */
#define TkPointerDeadWindow (tkIntPlatStubsPtr->tkPointerDeadWindow) /* 3 */
#define TkpSetCapture (tkIntPlatStubsPtr->tkpSetCapture) /* 4 */
#define TkpSetCursor (tkIntPlatStubsPtr->tkpSetCursor) /* 5 */
#define TkpWmSetState (tkIntPlatStubsPtr->tkpWmSetState) /* 6 */
#define TkAboutDlg (tkIntPlatStubsPtr->tkAboutDlg) /* 7 */
...
/* Slot 13 is reserved */
#define TkMacOSXDoHLEvent (tkIntPlatStubsPtr->tkMacOSXDoHLEvent) /* 14 */
/* Slot 15 is reserved */
#define TkMacOSXGetXWindow (tkIntPlatStubsPtr->tkMacOSXGetXWindow) /* 16 */
#define TkMacOSXGrowToplevel (tkIntPlatStubsPtr->tkMacOSXGrowToplevel) /* 17 \
                                                                          */
...
#define TkMacOSXMenuClick (tkIntPlatStubsPtr->tkMacOSXMenuClick) /* 25 */
#define TkMacOSXRegisterOffScreenWindow \
  (tkIntPlatStubsPtr->tkMacOSXRegisterOffScreenWindow) /* 26 */
#define TkMacOSXResizable (tkIntPlatStubsPtr->tkMacOSXResizable) /* 27 */
...
#define TkMacOSXUseMenuID (tkIntPlatStubsPtr->tkMacOSXUseMenuID) /* 34 */
#define TkMacOSXVisableClipRgn \
  (tkIntPlatStubsPtr->tkMacOSXVisableClipRgn) /* 35 */
#define TkMacOSXWinBounds (tkIntPlatStubsPtr->tkMacOSXWinBounds) /* 36 */
#define TkMacOSXWindowOffset (tkIntPlatStubsPtr->tkMacOSXWindowOffset) /* 37 \
                                                                          */
#define TkSetMacColor (tkIntPlatStubsPtr->tkSetMacColor) /* 38 */
#define TkSetWMName (tkIntPlatStubsPtr->tkSetWMName) /* 39 */
#define TkSuspendClipboard (tkIntPlatStubsPtr->tkSuspendClipboard) /* 40 */
#define TkMacOSXZoomToplevel (tkIntPlatStubsPtr->tkMacOSXZoomToplevel) /* 41 \
                                                                          */
#define Tk_TopCoordsToWindow (tkIntPlatStubsPtr->tk_TopCoordsToWindow) /* 42 \
                                                                          */
#define TkMacOSXContainerId (tkIntPlatStubsPtr->tkMacOSXContainerId) /* 43 */
...
#define TkpIsWindowFloating (tkIntPlatStubsPtr->tkpIsWindowFloating) /* 46 */
#define TkMacOSXGetCapture (tkIntPlatStubsPtr->tkMacOSXGetCapture) /* 47 */
/* Slot 48 is reserved */
#define TkGetTransientMaster (tkIntPlatStubsPtr->tkGetTransientMaster) /* 49 \
                                                                          */
#define TkGenerateButtonEvent \
  (tkIntPlatStubsPtr->tkGenerateButtonEvent) /* 50 */
#define TkGenWMDestroyEvent (tkIntPlatStubsPtr->tkGenWMDestroyEvent) /* 51 */
#define TkMacOSXSetDrawingEnabled \
  (tkIntPlatStubsPtr->tkMacOSXSetDrawingEnabled) /* 52 */
#define TkpGetMS (tkIntPlatStubsPtr->tkpGetMS) /* 53 */
#define TkMacOSXDrawable (tkIntPlatStubsPtr->tkMacOSXDrawable) /* 54 */
#define TkpScanWindowId (tkIntPlatStubsPtr->tkpScanWindowId) /* 55 */
#endif /* AQUA */
#if !(defined(_WIN32) || defined(__CYGWIN__) || defined(MAC_OSX_TK)) /* X11 */
#define TkCreateXEventSource (tkIntPlatStubsPtr->tkCreateXEventSource) /* 0 */
/* Slot 1 is reserved */
/* Slot 2 is reserved */
#define TkpCmapStressed (tkIntPlatStubsPtr->tkpCmapStressed) /* 3 */
#define TkpSync (tkIntPlatStubsPtr->tkpSync) /* 4 */
#define TkUnixContainerId (tkIntPlatStubsPtr->tkUnixContainerId) /* 5 */
#define TkUnixDoOneXEvent (tkIntPlatStubsPtr->tkUnixDoOneXEvent) /* 6 */
#define TkUnixSetMenubar (tkIntPlatStubsPtr->tkUnixSetMenubar) /* 7 */
#define TkpScanWindowId (tkIntPlatStubsPtr->tkpScanWindowId) /* 8 */
#define TkWmCleanup (tkIntPlatStubsPtr->tkWmCleanup) /* 9 */
#define TkSendCleanup (tkIntPlatStubsPtr->tkSendCleanup) /* 10 */
/* Slot 11 is reserved */
#define TkpWmSetState (tkIntPlatStubsPtr->tkpWmSetState) /* 12 */
#define TkpTestsendCmd (tkIntPlatStubsPtr->tkpTestsendCmd) /* 13 */
#endif /* X11 */
