...
typedef struct odbcStubDefs {
  ...
  SQLRETURN(SQL_API* SQLBindParameterPtr)
  (SQLHSTMT,
   SQLUSMALLINT,
   SQLSMALLINT,
   SQLSMALLINT,
  ...
  SQLRETURN(SQL_API* SQLColumnsWPtr)
  (SQLHSTMT,
   SQLWCHAR*,
   SQLSMALLINT,
   SQLWCHAR*,
   ...
   SQLWCHAR*,
   SQLSMALLINT);
  SQLRETURN(SQL_API* SQLDataSourcesWPtr)
  (SQLHENV,
   SQLUSMALLINT,
   SQLWCHAR*,
   SQLSMALLINT,
   ...
   SQLSMALLINT,
   SQLSMALLINT*);
  SQLRETURN(SQL_API* SQLDescribeColWPtr)
  (SQLHSTMT,
   SQLUSMALLINT,
   SQLWCHAR*,
   SQLSMALLINT,
   ...
   SQLSMALLINT*,
   SQLSMALLINT*);
  SQLRETURN(SQL_API* SQLDescribeParamPtr)
  (SQLHSTMT, SQLUSMALLINT, SQLSMALLINT*, SQLULEN*, SQLSMALLINT*, SQLSMALLINT*);
  SQLRETURN(SQL_API* SQLDisconnectPtr)(SQLHDBC);
  SQLRETURN(SQL_API* SQLDriverConnectWPtr)
  (SQLHDBC,
   SQLHWND,
   SQLWCHAR*,
   SQLSMALLINT,
   ...
   SQLSMALLINT*,
   SQLUSMALLINT);
  SQLRETURN(SQL_API* SQLDriversWPtr)
  (SQLHENV,
   SQLUSMALLINT,
   SQLWCHAR*,
   SQLSMALLINT,
  ...
  SQLRETURN(SQL_API* SQLForeignKeysWPtr)
  (SQLHSTMT,
   SQLWCHAR*,
   SQLSMALLINT,
   SQLWCHAR*,
  ...
  SQLRETURN(SQL_API* SQLGetConnectAttrPtr)
  (SQLHDBC, SQLINTEGER, SQLPOINTER, SQLINTEGER, SQLINTEGER*);
  SQLRETURN(SQL_API* SQLGetDataPtr)
  (SQLHSTMT, SQLUSMALLINT, SQLSMALLINT, SQLPOINTER, SQLLEN, SQLLEN*);
  SQLRETURN(SQL_API* SQLGetDiagFieldAPtr)
  (SQLSMALLINT,
   SQLHANDLE,
   SQLSMALLINT,
   SQLSMALLINT,
   ...
   SQLSMALLINT,
   SQLSMALLINT*);
  SQLRETURN(SQL_API* SQLGetDiagRecWPtr)
  (SQLSMALLINT,
   SQLHANDLE,
   SQLSMALLINT,
   SQLWCHAR*,
  ...
  SQLRETURN(SQL_API* SQLPrimaryKeysWPtr)
  (SQLHSTMT,
   SQLWCHAR*,
   SQLSMALLINT,
   SQLWCHAR*,
