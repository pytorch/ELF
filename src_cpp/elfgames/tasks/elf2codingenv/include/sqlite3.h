...
SQLITE_API int sqlite3_set_authorizer(
    sqlite3*,
    int (
        *xAuth)(void*, int, const char*, const char*, const char*, const char*),
    void* pUserData);
...
SQLITE_API SQLITE_DEPRECATED int sqlite3_transfer_bindings(
    sqlite3_stmt*,
    sqlite3_stmt*);
...
SQLITE_API void
sqlite3_result_pointer(sqlite3_context*, void*, const char*, void (*)(void*));
...
*/
SQLITE_API int
sqlite3_db_status(sqlite3*, int op, int* pCur, int* pHiwtr, int resetFlg);
...
*/
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_snapshot_recover(
    sqlite3* db,
    const char* zDb);
...
*/
SQLITE_API int sqlite3session_indirect(
