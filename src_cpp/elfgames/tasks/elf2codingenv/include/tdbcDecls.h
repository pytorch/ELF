...
/* 1 */
TDBCAPI Tcl_Obj* Tdbc_TokenizeSql(Tcl_Interp* interp, const char* statement);
/* 2 */
...
typedef struct TdbcStubs {
  ...
  Tcl_Obj* (
      *tdbc_TokenizeSql)(Tcl_Interp* interp, const char* statement); /* 1 */
...
#define Tdbc_Init_ (tdbcStubsPtr->tdbc_Init_) /* 0 */
#define Tdbc_TokenizeSql (tdbcStubsPtr->tdbc_TokenizeSql) /* 1 */
#define Tdbc_MapSqlState (tdbcStubsPtr->tdbc_MapSqlState) /* 2 */
