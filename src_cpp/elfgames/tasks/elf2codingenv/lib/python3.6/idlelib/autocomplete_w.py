...
class AutoCompleteWindow:
    ...
    def show_window(self, comp_lists, index, complete, mode, userWantsWin):
        ...
        self.hidewid = self.widget.bind(
            HIDE_VIRTUAL_EVENT_NAME, self.hide_event)
        ...
        self.widget.event_add(
            KEYRELEASE_VIRTUAL_EVENT_NAME, KEYRELEASE_SEQUENCE)
    ...
    def hide_window(self):
        ...
        if self.winconfigid:
            self.autocompletewindow.unbind(
                WINCONFIG_SEQUENCE, self.winconfigid)
            self.winconfigid = None
