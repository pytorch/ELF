...
class IdleConfTest(unittest.TestCase):
    ...
    def test_get_current_theme_and_keys(self):
        ...
        self.assertEqual(conf.CurrentTheme(),
                         conf.current_colors_and_keys('Theme'))
        self.assertEqual(conf.CurrentKeys(),
...
##        eq(conf.GetExtensionKeys('ZoomHeight'), {'<<zoom-height>>': key})
    ...
    def test_get_keyset(self):
        ...
        conf.defaultCfg['extensions'].set(
            'Foobar_cfgBindings', 'newfoo', '<Key-F3>')
    ...
    def test_extra_help_source_list(self):
        ...
        conf.userCfg['main'].SetOption(
            'HelpFiles', '4', 'Python;https://python.org')  # This is bad input
        conf.userCfg['main'].SetOption(
            'HelpFiles', '3', 'Python:https://python.org')  # This is bad input
        conf.userCfg['main'].SetOption(
