...
class HighPage(Frame):
    ...
    def create_page_highlight(self):
        ...
        self.style.configure('frame_color_set.TFrame', borderwidth=1,
                             relief='solid')
        self.frame_color_set = Frame(
            frame_custom, style='frame_color_set.TFrame')
        ...
        # frame_custom.
        self.frame_color_set.pack(
            side=TOP, padx=5, pady=5, expand=TRUE, fill=X)
        frame_fg_bg_toggle.pack(side=TOP, padx=5, pady=0)
        self.highlight_sample.pack(
            side=TOP, padx=5, pady=5, expand=TRUE, fill=BOTH)
        self.button_set_color.pack(
            side=TOP, expand=TRUE, fill=X, padx=8, pady=4)
    ...
    def delete_custom(self):
        ...
        self.theme_source.set(
            idleConf.defaultCfg['main'].Get('Theme', 'default'))
...
class KeysPage(Frame):
    ...
    def create_page_keys(self):
        ...
        self.button_delete_custom_keys.pack(
            side=LEFT, fill=X, expand=True, padx=2)
        self.button_save_custom_keys.pack(
            side=LEFT, fill=X, expand=True, padx=2)
