...
class Test_find_binding(support.TestCase):
    ...
    def test_from_import_as_with_package(self):
        ...
        self.assertFalse(self.find_binding(
            "a", "from x import g as a, d as b", "x"))
        self.assertFalse(self.find_binding(
            "a", "from x.b import t as a", "x.b"))
        self.assertFalse(self.find_binding(
            "a", "from x.b import g as a, d", "x.b"))
