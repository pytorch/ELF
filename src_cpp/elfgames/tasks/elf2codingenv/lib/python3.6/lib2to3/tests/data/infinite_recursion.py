...
assert sizeof(N12asn1_type_st4DOLLAR_11E) == 4, sizeof(
    N12asn1_type_st4DOLLAR_11E)
assert alignment(N12asn1_type_st4DOLLAR_11E) == 4, alignment(
    N12asn1_type_st4DOLLAR_11E)
...
BIO = bio_st
bio_info_cb = CFUNCTYPE(None, POINTER(bio_st), c_int,
                        STRING, c_int, c_long, c_long)
...
bio_st._fields_ = [
    ...
    ('callback', CFUNCTYPE(c_long, POINTER(bio_st),
                           c_int, STRING, c_int, c_long, c_long)),
    ('cb_arg', STRING),
    ('init', c_int),
    ('shutdown', c_int),
    ('flags', c_int),
...
assert alignment(bio_f_buffer_ctx_struct) == 4, alignment(
...
BIO_dummy = bio_st
CRYPTO_EX_new = CFUNCTYPE(c_int, c_void_p, c_void_p, POINTER(
    CRYPTO_EX_DATA), c_int, c_long, c_void_p)
CRYPTO_EX_free = CFUNCTYPE(None, c_void_p, c_void_p, POINTER(
    CRYPTO_EX_DATA), c_int, c_long, c_void_p)
CRYPTO_EX_dup = CFUNCTYPE(c_int, POINTER(CRYPTO_EX_DATA), POINTER(
    CRYPTO_EX_DATA), c_void_p, c_int, c_long, c_void_p)
...
assert alignment(crypto_ex_data_func_st) == 4, alignment(
...
CRYPTO_MEM_LEAK_CB = CFUNCTYPE(
    c_void_p, c_ulong, STRING, c_int, c_int, c_void_p)
...
assert sizeof(N23_ossl_old_des_ks_struct4DOLLAR_10E) == 8, sizeof(
...
assert alignment(_ossl_old_des_ks_struct) == 4, alignment(
...
dh_method._fields_ = [
    ...
    ('bn_mod_exp', CFUNCTYPE(c_int, POINTER(DH), POINTER(BIGNUM), POINTER(BIGNUM),
                             POINTER(BIGNUM), POINTER(BIGNUM), POINTER(BN_CTX), POINTER(BN_MONT_CTX))),
...
dsa_method._fields_ = [
    ...
    ('dsa_sign_setup', CFUNCTYPE(c_int, POINTER(DSA), POINTER(
        BN_CTX), POINTER(POINTER(BIGNUM)), POINTER(POINTER(BIGNUM)))),
    ('dsa_do_verify', CFUNCTYPE(c_int, POINTER(
        c_ubyte), c_int, POINTER(DSA_SIG), POINTER(DSA))),
    ('dsa_mod_exp', CFUNCTYPE(c_int, POINTER(DSA), POINTER(BIGNUM), POINTER(BIGNUM), POINTER(BIGNUM),
                              POINTER(BIGNUM), POINTER(BIGNUM), POINTER(BIGNUM), POINTER(BN_CTX), POINTER(BN_MONT_CTX))),
    ('bn_mod_exp', CFUNCTYPE(c_int, POINTER(DSA), POINTER(BIGNUM), POINTER(BIGNUM),
                             POINTER(BIGNUM), POINTER(BIGNUM), POINTER(BN_CTX), POINTER(BN_MONT_CTX))),
...
assert sizeof(N11evp_pkey_st4DOLLAR_12E) == 4, sizeof(
    N11evp_pkey_st4DOLLAR_12E)
assert alignment(N11evp_pkey_st4DOLLAR_12E) == 4, alignment(
    N11evp_pkey_st4DOLLAR_12E)
...
evp_cipher_st._fields_ = [
    ...
    ('iv_len', c_int),
    ('flags', c_ulong),
    ('init', CFUNCTYPE(c_int, POINTER(EVP_CIPHER_CTX),
                       POINTER(c_ubyte), POINTER(c_ubyte), c_int)),
    ('do_cipher', CFUNCTYPE(c_int, POINTER(EVP_CIPHER_CTX),
                            POINTER(c_ubyte), POINTER(c_ubyte), c_uint)),
    ('cleanup', CFUNCTYPE(c_int, POINTER(EVP_CIPHER_CTX))),
    ('ctx_size', c_int),
    ('set_asn1_parameters', CFUNCTYPE(
        c_int, POINTER(EVP_CIPHER_CTX), POINTER(ASN1_TYPE))),
    ('get_asn1_parameters', CFUNCTYPE(
        c_int, POINTER(EVP_CIPHER_CTX), POINTER(ASN1_TYPE))),
...
EVP_PBE_KEYGEN = CFUNCTYPE(c_int, POINTER(EVP_CIPHER_CTX), STRING, c_int, POINTER(
    ASN1_TYPE), POINTER(EVP_CIPHER), POINTER(EVP_MD), c_int)
...
assert alignment(N10pem_ctx_st4DOLLAR_16E) == 4, alignment(
...
assert alignment(N10pem_ctx_st4DOLLAR_17E) == 4, alignment(
...
assert sizeof(pkcs7_issuer_and_serial_st) == 8, sizeof(
    pkcs7_issuer_and_serial_st)
assert alignment(pkcs7_issuer_and_serial_st) == 4, alignment(
    pkcs7_issuer_and_serial_st)
...
assert sizeof(pkcs7_signedandenveloped_st) == 28, sizeof(
    pkcs7_signedandenveloped_st)
assert alignment(pkcs7_signedandenveloped_st) == 4, alignment(
    pkcs7_signedandenveloped_st)
...
rsa_meth_st._fields_ = [
    ('name', STRING),
    ('rsa_pub_enc', CFUNCTYPE(c_int, c_int, POINTER(
        c_ubyte), POINTER(c_ubyte), POINTER(RSA), c_int)),
    ('rsa_pub_dec', CFUNCTYPE(c_int, c_int, POINTER(
        c_ubyte), POINTER(c_ubyte), POINTER(RSA), c_int)),
    ('rsa_priv_enc', CFUNCTYPE(c_int, c_int, POINTER(
        c_ubyte), POINTER(c_ubyte), POINTER(RSA), c_int)),
    ('rsa_priv_dec', CFUNCTYPE(c_int, c_int, POINTER(
        c_ubyte), POINTER(c_ubyte), POINTER(RSA), c_int)),
    ('rsa_mod_exp', CFUNCTYPE(c_int, POINTER(BIGNUM), POINTER(BIGNUM), POINTER(RSA))),
    ('bn_mod_exp', CFUNCTYPE(c_int, POINTER(BIGNUM), POINTER(BIGNUM), POINTER(
        BIGNUM), POINTER(BIGNUM), POINTER(BN_CTX), POINTER(BN_MONT_CTX))),
    ('init', CFUNCTYPE(c_int, POINTER(RSA))),
    ('finish', CFUNCTYPE(c_int, POINTER(RSA))),
    ('flags', c_int),
    ('app_data', STRING),
    ('rsa_sign', CFUNCTYPE(c_int, c_int, POINTER(c_ubyte),
                           c_uint, POINTER(c_ubyte), POINTER(c_uint), POINTER(RSA))),
    ('rsa_verify', CFUNCTYPE(c_int, c_int, POINTER(c_ubyte),
                             c_uint, POINTER(c_ubyte), c_uint, POINTER(RSA))),
]
...
ssl_method_st._fields_ = [
    ...
    ('ssl_ctx_callback_ctrl', CFUNCTYPE(
        c_long, POINTER(SSL_CTX), c_int, CFUNCTYPE(None))),
]
...
GEN_SESSION_CB = CFUNCTYPE(c_int, POINTER(
    SSL), POINTER(c_ubyte), POINTER(c_uint))
...
assert alignment(N10ssl_ctx_st4DOLLAR_18E) == 4, alignment(
...
ssl_ctx_st._fields_ = [
    ...
    ('get_session_cb', CFUNCTYPE(POINTER(SSL_SESSION), POINTER(
        ssl_st), POINTER(c_ubyte), c_int, POINTER(c_int))),
    ...
    ('client_cert_cb', CFUNCTYPE(c_int, POINTER(SSL),
                                 POINTER(POINTER(X509)), POINTER(POINTER(EVP_PKEY)))),
    ('ex_data', CRYPTO_EX_DATA),
    ...
    ('read_ahead', c_int),
    ('msg_callback', CFUNCTYPE(None, c_int, c_int,
                               c_int, c_void_p, c_ulong, POINTER(SSL), c_void_p)),
...
assert sizeof(N13ssl2_state_st4DOLLAR_19E) == 72, sizeof(
    N13ssl2_state_st4DOLLAR_19E)
assert alignment(N13ssl2_state_st4DOLLAR_19E) == 4, alignment(
    N13ssl2_state_st4DOLLAR_19E)
...
assert sizeof(N13ssl3_state_st4DOLLAR_20E) == 296, sizeof(
    N13ssl3_state_st4DOLLAR_20E)
assert alignment(N13ssl3_state_st4DOLLAR_20E) == 4, alignment(
    N13ssl3_state_st4DOLLAR_20E)
...
assert sizeof(N18x509_attributes_st4DOLLAR_13E) == 4, sizeof(
    N18x509_attributes_st4DOLLAR_13E)
assert alignment(N18x509_attributes_st4DOLLAR_13E) == 4, alignment(
    N18x509_attributes_st4DOLLAR_13E)
...
assert sizeof(Netscape_certificate_sequence) == 8, sizeof(
    Netscape_certificate_sequence)
assert alignment(Netscape_certificate_sequence) == 4, alignment(
    Netscape_certificate_sequence)
...
assert alignment(pkcs8_priv_key_info_st) == 4, alignment(
...
assert sizeof(N14x509_object_st4DOLLAR_14E) == 4, sizeof(
...
x509_lookup_method_st._fields_ = [
    ...
    ('ctrl', CFUNCTYPE(c_int, POINTER(X509_LOOKUP),
                       c_int, STRING, c_long, POINTER(STRING))),
    ('get_by_subject', CFUNCTYPE(c_int, POINTER(X509_LOOKUP),
                                 c_int, POINTER(X509_NAME), POINTER(X509_OBJECT))),
    ('get_by_issuer_serial', CFUNCTYPE(c_int, POINTER(X509_LOOKUP), c_int,
                                       POINTER(X509_NAME), POINTER(ASN1_INTEGER), POINTER(X509_OBJECT))),
    ('get_by_fingerprint', CFUNCTYPE(c_int, POINTER(X509_LOOKUP),
                                     c_int, POINTER(c_ubyte), c_int, POINTER(X509_OBJECT))),
    ('get_by_alias', CFUNCTYPE(c_int, POINTER(X509_LOOKUP),
                               c_int, STRING, c_int, POINTER(X509_OBJECT))),
]
...
x509_store_st._fields_ = [
    ...
    ('get_issuer', CFUNCTYPE(c_int, POINTER(POINTER(X509)),
                             POINTER(X509_STORE_CTX), POINTER(X509))),
    ('check_issued', CFUNCTYPE(c_int, POINTER(
        X509_STORE_CTX), POINTER(X509), POINTER(X509))),
    ('check_revocation', CFUNCTYPE(c_int, POINTER(X509_STORE_CTX))),
    ('get_crl', CFUNCTYPE(c_int, POINTER(X509_STORE_CTX),
                          POINTER(POINTER(X509_CRL)), POINTER(X509))),
    ('check_crl', CFUNCTYPE(c_int, POINTER(X509_STORE_CTX), POINTER(X509_CRL))),
    ('cert_crl', CFUNCTYPE(c_int, POINTER(
        X509_STORE_CTX), POINTER(X509_CRL), POINTER(X509))),
...
assert sizeof(__darwin_pthread_handler_rec) == 12, sizeof(
    __darwin_pthread_handler_rec)
assert alignment(__darwin_pthread_handler_rec) == 4, alignment(
    __darwin_pthread_handler_rec)
...
assert alignment(_opaque_pthread_attr_t) == 4, alignment(
...
assert alignment(_opaque_pthread_cond_t) == 4, alignment(
...
assert sizeof(_opaque_pthread_condattr_t) == 8, sizeof(
    _opaque_pthread_condattr_t)
assert alignment(_opaque_pthread_condattr_t) == 4, alignment(
    _opaque_pthread_condattr_t)
...
assert alignment(_opaque_pthread_mutex_t) == 4, alignment(
...
assert sizeof(_opaque_pthread_mutexattr_t) == 12, sizeof(
...
assert alignment(_opaque_pthread_once_t) == 4, alignment(
...
assert sizeof(_opaque_pthread_rwlock_t) == 128, sizeof(
    _opaque_pthread_rwlock_t)
assert alignment(_opaque_pthread_rwlock_t) == 4, alignment(
    _opaque_pthread_rwlock_t)
...
assert sizeof(_opaque_pthread_rwlockattr_t) == 16, sizeof(
