            ...
            if name == 'drive':
                ...
                if name == 'basename':
                    ...
                    if name == 'purebasename':
                        ...
                        raise ValueError(
                            "invalid part specification %r" % name)
        return res
    ...
    def make_numbered_dir(cls, prefix='session-', rootdir=None, keep=3,
        ...
        def create_lockfile(path):
            ...
            if hasattr(lockfile, 'mksymlinkto'):
                ...
                fd = py.error.checked_call(os.open, str(
                    lockfile), os.O_WRONLY | os.O_CREAT | os.O_EXCL, 0o644)
        ...
        if keep and udir_time:
            for path in rootdir.listdir():
                ...
                if num is not None and num <= (maxnum - keep):
                    ...
                    garbage_path = rootdir.join(
                        garbage_prefix + str(uuid.uuid4()))
                    try:
