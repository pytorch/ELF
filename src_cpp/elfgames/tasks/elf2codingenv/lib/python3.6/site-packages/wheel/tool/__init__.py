...
def sign(wheelfile, replace=False, get_keyring=get_keyring):
    ...
    payload = {"hash": "sha256=" +
               native(urlsafe_b64encode(hashlib.sha256(record_data).digest()))}
...
def parser():
    ...
    install_scripts_parser = s.add_parser(
        'install-scripts', help='Install console_scripts')
    ...
    convert_parser = s.add_parser(
        'convert', help='Convert egg or wininst to wheel')
    convert_parser.add_argument(
        'installers', nargs='*', help='Installers to convert')
