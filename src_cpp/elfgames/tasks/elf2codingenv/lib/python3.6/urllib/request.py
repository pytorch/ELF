...
class AbstractDigestAuthHandler:
    ...
    def get_algorithm_impls(self, algorithm):
        ...
        if algorithm == 'MD5':
            def H(x): return hashlib.md5(x.encode("ascii")).hexdigest()
        elif algorithm == 'SHA':
            def H(x): return hashlib.sha1(x.encode("ascii")).hexdigest()
        # XXX MD5-sess
        else:
...
class URLopener:
    ...
    def open(self, fullurl, data=None):
        ...
        try:
            ...
            raise OSError('socket error', msg).with_traceback(
                sys.exc_info()[2])
    ...
    def _open_generic_http(self, connection_factory, url, data):
        ...
        if proxy_passwd:
            ...
            proxy_auth = base64.b64encode(
                proxy_passwd.encode()).decode('ascii')
        else:
            proxy_auth = None
    ...
    def open_local_file(self, url):
        ...
        if (not port
            ...
            if file[:1] == '/':
                ...
                raise ValueError(
                    "local file url may start with / or file:. Unknown url of type: %s" % url)
            return addinfourl(open(localname, 'rb'), headers, urlfile)
    ...
    def open_ftp(self, url):
        ...
        try:
            ...
            raise URLError('ftp error %r' %
                           exp).with_traceback(sys.exc_info()[2])
