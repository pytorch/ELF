...
class DirSelectBox(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixDirSelectBox',
                           ['options'], cnf, kw)
...
class ExFileSelectBox(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixExFileSelectBox', [
                           'options'], cnf, kw)
        ...
        self.subwidget_list['filelist'] = _dummyScrolledListBox(
            self, 'filelist')
...
class ListNoteBook(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixListNoteBook',
                           ['options'], cnf, kw)
...
class OptionMenu(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        ...
        self.subwidget_list['menubutton'] = _dummyMenubutton(
            self, 'menubutton')
    ...
    def add_separator(self, name, cnf={}, **kw):
        self.tk.call(self._w, 'add', 'separator',
                     name, *self._options(cnf, kw))
...
class PanedWindow(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixPanedWindow', [
                           'orientation', 'options'], cnf, kw)
...
class ScrolledListBox(TixWidget):
    ...
    # FIXME: It should inherit -superclass tixScrolledWidget
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixScrolledListBox', [
                           'options'], cnf, kw)
...
class ScrolledText(TixWidget):
    ...
    # FIXME: It should inherit -superclass tixScrolledWidget
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixScrolledText',
                           ['options'], cnf, kw)
...
class ScrolledWindow(TixWidget):
    ...
    # FIXME: It should inherit -superclass tixScrolledWidget
    def __init__(self, master, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixScrolledWindow', [
                           'options'], cnf, kw)
...
class Shell(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixShell', [
                           'options', 'title'], cnf, kw)
