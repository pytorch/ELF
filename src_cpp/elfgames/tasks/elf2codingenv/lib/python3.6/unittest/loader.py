...
class TestLoader(object):
    ...
    def loadTestsFromModule(self, module, *args, pattern=None, **kws):
        ...
        if len(args) > 1:
            ...
            raise TypeError(
                'loadTestsFromModule() takes 1 positional argument but {} were given'.format(complaint))
        if len(kws) != 0:
            ...
            raise TypeError(
                "loadTestsFromModule() got an unexpected keyword argument '{}'".format(complaint))
        tests = []
