...
void registerPy(pybind11::module& m) {
  ...
  py::class_<ChouFleurGameSelfPlay>(m, "ChouFleurGameSelfPlay")
      .def("showBoard", &ChouFleurGameSelfPlay::showBoard)
      .def("getNextPlayer", &ChouFleurGameSelfPlay::getNextPlayer)
      .def("getLastMove", &ChouFleurGameSelfPlay::getLastMove)
      .def("getScore", &ChouFleurGameSelfPlay::getScore)
      .def("getLastScore", &ChouFleurGameSelfPlay::getLastScore);
}
