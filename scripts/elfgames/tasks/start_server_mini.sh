...
save=./myserver game=elfgames.tasks.game model=df_kl model_file=elfgames.tasks.df_model3 \
    ...
    --num_games 1000 --keys_in_reply V \
    --T 1    --use_data_parallel \
    --num_minibatch 3    --num_episode 10 \
    ...
    --server_id myserver     --eval_num_games 40 \
    --eval_winrate_thres 0.55     --port 1234 \
    --q_min_size 200     --q_max_size 4000 \
    --save_first     \
    --num_block 2     --dim 19 \
    --weight_decay 0.0000    --opt_method sgd \
    ...
    --lr 0.1    --momentum 0.9     1>> ../../../log.log 2>&1 &
