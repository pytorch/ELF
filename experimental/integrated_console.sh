...
model_file=elfgames.go.df_model3 model=df_pred game=elfgames.go.client python -u ./experimental/df_console.py --common.mode online --common.base.num_game_thread 1 --common.base.verbose --common.mcts.verbose_time --common.mcts.num_thread 16 --common.mcts.num_rollout_per_thread -1 --following_pass \
